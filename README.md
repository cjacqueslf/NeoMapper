...
O código canônico está na versão `4.2.2`. Consulte `REQUIREMENTS.md`,
`ARCHITECTURE.md` e `ROADMAP.md` antes de desenvolver funcionalidades.

## Instalação para usuários

No Windows, baixe `NEOMapper-4.2.2-Windows-x64-Setup.exe` na página da versão
...
```powershell
git tag -a v4.2.2 -m "NEOMapper 4.2.2"
